  ...
  return (
    <div className=' my-container'>
      <div className='grid grid-cols-1 md:grid-cols-4 gap-10 border-b-2 py-24'>
        <div>
          <Column gap={10} className='border'>
            <div className='font-bold text-lg'>CashLoansExpress.com</div>

            <div>
              <button className='bg-main text-white w-full p-3 text-center rounded-md'>
                <div>Get Started</div>
              </button>
            </div>
          </Column>
      ...
      <div>
        <Column className='gap-10 text-center w-full text-sm py-24'>
          <div>2021 CashLoansExpress, United States of America – All Rights Reserved</div>
          <div>Footnotes:</div>
          <div>(*) Your funds could be sent to your account as soon as 15 minutes once you have been approved. Your bank’s policies and procedures will determine how long it takes for the funds to arrive in your account.</div>
          ...
          <div>{`Service Role and Limitations. CashLoansExpress acts solely as a referral service and is not a lender. We do not predict or determine the fees, interest rates, or other financial implications associated with any loans you may be offered by participating lenders. Our role is to connect you with our network of qualified lenders, and we do not participate in the decision-making process regarding loan approvals, terms, or conditions. It’s important for users to understand that our service involves no predictive assessment or guarantee of the loan terms you may receive.`}</div>
